def calculate_months_to_target(start_balance, target_balance, win_rate, rr_ratio, trades_per_month):
    balance = start_balance
    months = 0

    while balance < target_balance:
        # Recalculate risk per trade based on 10% of the balance
        risk_per_trade = 0.10 * balance
...
def main():
    ...
    print(f"\nIt will take {months} months to grow your account from ${start_balance:.2f} to ${target_balance:.2f}.")
